...
// PROLOGUE
#define LOCTEXT_NAMESPACE "FInteractMLEditorModule"
...
{
	UE_LOG( LogInteractML, Display, TEXT( "Starting InteractML Editor Plugin" ) );
...
{
	UE_LOG( LogInteractML, Display, TEXT( "Stopping InteractML Editor Plugin" ) );
