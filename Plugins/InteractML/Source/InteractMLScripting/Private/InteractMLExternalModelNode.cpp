...
void UInteractMLExternalModelNode::AllocateDefaultPins()
{
	...
	// What type of model?
	UEdGraphPin* type_pin = CreatePin(EGPD_Input, UEdGraphSchema_K2::PC_Class, UInteractMLModel::StaticClass(), FInteractMLExternalModelNodePinNames::ModelTypeInputPinName);
	data_pin->PinToolTip = LOCTEXT("ExternalModelNodeModelTypePinTooltip", "The type of the model being referred to by the data path.").ToString();
